(function () {
  window.onload = function () {
    ...
    function draw () {
      ...
      // ct.crash(ct.rnd(1, 2))
      // ct.col(ct.rnd(4, 8))
      ct.oval(ct.cx, ct.cy, ct.h / 1.0, ct.rnd(4, 12))
      ct.crash(ct.mx)
    }
